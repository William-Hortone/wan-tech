            ...
            <div className='flex flex-col-reverse items-center justify-center w-full h-full lg:justify-between lg:flex-row ' >
                <div className='flex flex-col items-center justify-center w-full h-full gap-4 md:pl-12 md:pr-2 lg:items-start'   >
                    <div className='px-8 text-center lg:text-left'>
                        <h2 className="text-3xl font-bold text-neutral-400 sm:text-5xl md:text-5xl lg:text-6xl">
                            Vos projets   <br />
                            prennent vie  <br />
                            entre
                    ...
                    <div className='flex gap-2'>
                        ...
                        >
                            <div className="flex items-center z-50 min-w-[150px] text-[12px] md:text-[15px] md:w-[200px]  justify-start app__button-content bg-basic">
