...
const Footer = () => {
  return (
    <>
      <section className="w-full h-screen relative bg-basic flex flex-col justify-between text-black  p-16 z-10">
        ...
        <div className="flex justify-between mt-8">
          <div className="mr-4">
            <h2 className="font-bold font-fontAlt uppercase ">
              Contactez-nous
            </h2>
            <h3 className="font-medium">wantech@gmail.com</h3>
            <h2 className="font-bold font-fontAlt mt-4 uppercase">
              Liens Rapides
            </h2>
